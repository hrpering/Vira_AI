...
| AutoGen | [microsoft/autogen](https://github.com/microsoft/autogen) | MIT | Framework for multi-agent conversation and application patterns | A potential hosted workflow surface and operational controls | Ecosystem reference; no native Vira integration claim in this repository |
